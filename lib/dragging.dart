...
/// [ReorderableListViewCustom.buildDefaultDragHandles].
///
/// All list items must have a key.
///
/// This example demonstrates using the [ReorderableListViewCustom.proxyDecorator] callback
/// to customize the appearance of a list item while it's being dragged.
///
/// {@tool dartpad}
/// While a drag is underway, the widget returned by the [ReorderableListViewCustom.proxyDecorator]
/// callback serves as a "proxy" (a substitute) for the item in the list. The proxy is
/// created with the original list item as its child. The [ReorderableListViewCustom.proxyDecorator]
...
/// {@end-tool}
///
/// This example demonstrates using the [ReorderableListViewCustom.proxyDecorator] callback to
...
/// its elevation. This example demonstrates how to use the [ReorderableListViewCustom.proxyDecorator]
...
class ReorderableListViewCustom extends StatefulWidget {
  ...
  /// created in advance, or all at once when the [ReorderableListViewCustom] itself
  /// is created, it is more efficient to use the [ReorderableListViewCustom]
  ...
  /// See also:
  ///
  ///   * [ReorderableListViewCustom], which allows you to build a reorderable
...
class _ReorderableListViewCustomState extends State<ReorderableListViewCustom> {
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    if (widget.buildDefaultDragHandles) {
      //print("====TargetPlatform =====${Theme.of(context).platform} =======");
